...
import { SearchEditComponent} from './pages/search-edit/search-edit.component';
import { SearchListComponent} from './pages/search-list/search-list.component';
import { SecurityEditComponent} from './pages/security-edit/security-edit.component';
...
const routes: Routes = [
    ...
    { path: 'searchs/:id',  loadChildren: './pages/search-edit/search-edit.module#SearchEditModule' , canActivate: [AuthGuard] },
    { path: 'searchs',  loadChildren: './pages/search-list/search-list.module#SearchListModule' , canActivate: [AuthGuard] },
    { path: 'securitys/:id',  loadChildren: './pages/security-edit/security-edit.module#SecurityEditModule' , canActivate: [AuthGuard] },
    { path: 'securitys',  loadChildren: './pages/security-list/security-list.module#SecurityListModule' , canActivate: [AuthGuard] },
